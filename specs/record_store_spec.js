...
describe('The Record Store', function () {
  ...
  before(function () {
    store = new RecordStore("Colins Record Store", "Glasgow");
    record_1 = new Record("Colin", "A Hit like a BaseBall Bat out of Hell.", 10);
    record_2 = new Record("John", "This is my Jam", 15);
    record_3 = new Record("Alan", "Aint no paddler like a ping pong paddler", 20);
  });
